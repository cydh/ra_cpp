...
${OBJECTDIR}/ch_clif.o: ch_clif.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ch_clif.o ch_clif.cpp

${OBJECTDIR}/ch_csnif.o: ch_csnif.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ch_csnif.o ch_csnif.cpp

${OBJECTDIR}/ch_logif.o: ch_logif.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ch_logif.o ch_logif.cpp

${OBJECTDIR}/ch_main.o: ch_main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ch_main.o ch_main.cpp

${OBJECTDIR}/ch_mapif.o: ch_mapif.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ch_mapif.o ch_mapif.cpp

# Subprojects
.build-subprojects:
	cd ../ra_common && ${MAKE}  -f Makefile CONF=Debug
...
# Subprojects
.clean-subprojects:
	cd ../ra_common && ${MAKE}  -f Makefile CONF=Debug clean
